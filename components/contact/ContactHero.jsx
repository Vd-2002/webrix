      ...
      <div className="max-w-3xl mx-auto space-y-8 px-6">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-extrabold text-white font-display">Direct Line</div>
              <div className="text-[9px] font-mono text-white/30 tracking-wider uppercase font-semibold">hello@webrix.co</div>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-extrabold text-white font-display">&lt; 12 Hours</div>
              <div className="text-[9px] font-mono text-white/30 tracking-wider uppercase font-semibold">Average Response</div>
            </div>
          </div>
          <div className="flex items-center gap-3">
