      ...
      <div className="max-w-3xl mx-auto space-y-8 px-6">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-white/60 leading-relaxed font-sans max-w-2xl mx-auto pt-2">
            Explore our project directory. We build high-performance web systems, custom enterprise platforms, serverless AI infrastructures, and automated marketing setups optimized for sub-millisecond execution.
          </p>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <div className="text-[9px] font-mono text-white/30 tracking-wider uppercase font-semibold">Production Ready</div>
            </div>
          </div>
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="text-sm font-extrabold text-white font-display">Zero</div>
              <div className="text-[9px] font-mono text-white/30 tracking-wider uppercase font-semibold">Template Bloat</div>
            </div>
          </div>
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="text-sm font-extrabold text-white font-display">&lt;100ms</div>
              <div className="text-[9px] font-mono text-white/30 tracking-wider uppercase font-semibold">TBT Metrics</div>
            </div>
          </div>
        </motion.div>
      </div>
